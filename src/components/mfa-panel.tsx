  ...
  return (
    <div className="space-y-4">
      {!enabled ? (
        ...
        <>
          <div className="flex items-center justify-between gap-4 rounded-xl bg-green-50 p-4 dark:bg-emerald-950/40">
            <div>
            ...
            <form action={disableAction}>
              <button
                type="submit"
                disabled={disabling}
                className="rounded-full border border-red-300 px-4 py-2 text-sm font-semibold text-red-700 hover:bg-red-50 dark:border-red-800/50 dark:text-red-300 dark:hover:bg-red-950/40 disabled:opacity-50"
              >
