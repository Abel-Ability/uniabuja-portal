...
import { approveWaiver, rejectWaiver } from "@/lib/module-actions";
...
export function WaiverDecisionButtons({ waiverId }: { waiverId: string }) {
  const [approveState, approveAction, approving] = useActionState(approveWaiver, null);
  const [rejectState, rejectAction, rejecting] = useActionState(rejectWaiver, null);
