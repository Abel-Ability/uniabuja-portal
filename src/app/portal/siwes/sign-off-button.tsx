...
import { signOffSiwesRecord } from "@/lib/module-actions";

export function SignOffButton({ id }: { id: string }) {
  const [state, action, pending] = useActionState(signOffSiwesRecord, null);
  return (
